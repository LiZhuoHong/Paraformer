...
To address these limitation, we propose an efficient, weakly supervised framework (Paraformer), a.k.a Low-to-High Network (L2HNet) v2, to guide large-scale HR land-cover mapping with easy-access historical land-cover data of low resolution (LR). 

The code and data are regrouping. 
They will be upload before March/25/2024.
Stay tuned!
